  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      const postsData = snapshot.docs
        ...
        // 💡 關鍵篩選：依照頁面需求修改 "NewTaipei" 字串
        .filter((post: any) => post.category === "NewTaipei" && post.status === "published");
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="mb-12 border-b border-neutral-100 pb-8">
        <h1 className="text-4xl font-serif text-secondary italic">NewTaipei</h1>
